export const calculateFormValues = v => ({
  ...
  highGradeWeight: Number(v.gradeAA) + Number(v.gradeAB) + Number(v.gradeCAndPB),
  lowGradeWeight:
    Number(v.triage) + Number(v.pods) + Number(v.arabica1899) + Number(v.sweeppingsOrSpillages),
  totalBlackBeans: Number(v.blackBeansAA) + Number(v.blackBeansAB) + Number(v.blackBeansC),
